      ...
      >
        ...
        >
          <div
            style={{
              ...
              marginBottom: 6,
              letterSpacing: 0.5,
              fontFamily: "'League Spartan', 'Glacial Indifference', 'Inter', sans-serif",
            }}
          >
            Orders
          </div>
          <div style={{ fontSize: 16, color: "#888", fontWeight: 400, marginBottom: 18 }}>
        ...
        <div
          style={{
            ...
            height: 12,
            background: "linear-gradient(180deg, #fff 60%, #ececec 100%)",
            borderRadius: 8,
        ...
        <div
          ...
          style={{ display: "flex", overflowX: "auto", gap: 10, margin: "0 32px 20px", paddingBottom: 5 }}
        >
          {tabs.map((tab) => (
            <div
              key={tab}
        ...
        <div
          ...
          style={{ display: "flex", flexDirection: "column", gap: 15, padding: "0 32px 70px" }}
        >
          {mockOrders
            ...
            .map((order) => (
              ...
              >
                ...
                >
                  <span className="order-id" style={{ fontWeight: 600, fontSize: 16, color: "#111" }}>
                    Order #{order.id}
                  </span>
                  <span
                    ...
                    style={{
                      ...
                      padding: "4px 8px",
                      borderRadius: 4,
                      background: statusColors[order.status as StatusKey].bg,
                      color: statusColors[order.status as StatusKey].color,
                    }}
                  >
                    {order.status}
                  </span>
