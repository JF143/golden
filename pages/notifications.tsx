  ...
  return (
    <div style={{ background: "#f7f7f7", minHeight: "100vh", paddingBottom: 80 }}>
      ...
      >
        ...
        <span style={{ flexGrow: 1, textAlign: "center", fontWeight: 600, fontSize: 20, color: "#222" }}>
          Notifications
        </span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            {notifications.map((n) => (
              <div
                key={n.id}
                style={{
                  background: n.unread ? "#f8f6ef" : "#fff",
                  borderLeft: n.unread ? `3px solid ${gold}` : "3px solid transparent",
                  borderRadius: 12,
                  padding: 18,
                ...
                <div style={{ display: "flex", gap: 12, marginBottom: 10 }}>
                  <div
                    style={{
                      ...
                      fontSize: 20,
                      background: n.type === "order" ? "#fff8e1" : n.type === "promo" ? "#e3f2fd" : "#f5f5f5",
                      color: n.type === "order" ? gold : n.type === "promo" ? "#1976d2" : "#616161",
                    }}
                  >
                    <i
                      className={
