        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 30 }}>
            <div style={{
              ...
              <img src="/img/logo.png" alt="Golden Bites Logo" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            ...
            <div style={cardStyles}>
              ...
              <div style={{ padding: 15, textAlign: "center", borderTop: "1px solid #f0f0f0" }}>
                <a href="/sign-in" style={{
                  ...
                  width: "100%"
                }} onClick={() => { localStorage.setItem('userType', 'customer'); }}>Continue as Customer</a>
              </div>
            </div>
            <div style={cardStyles}>
              <div style={{ padding: 15, textAlign: "center", borderBottom: "1px solid #f0f0f0" }}>
              ...
              <div style={{ padding: 15, textAlign: "center", borderTop: "1px solid #f0f0f0" }}>
                <a href="/sign-in" style={{
                  ...
                  transition: "background-color 0.2s",
                  width: "100%"
                }} onClick={() => { localStorage.setItem('userType', 'merchant'); }}>Continue as Merchant</a>
              </div>
            </div>
          </div>
          <div style={{ textAlign: "center", marginTop: 20, fontSize: 12 }}>
            <p style={{ color: "#888", marginBottom: 3 }}>
              New to Golden Bites? <a href="/register" style={{ color: "#4a90e2", textDecoration: "none" }}>Create a customer account</a>
            </p>
            <p style={{ color: "#888", marginBottom: 3 }}>
              New to Golden Bites as a merchant? <a href="/sign-up" style={{ color: "#4a90e2", textDecoration: "none" }}>Become a merchant</a>
            </p>
          </div>
        </div>
      </div>
